    ...
    <>
        ...
        <div className="img">
            ...
            <div className="firstHeading">
                ...
                <button id="naviBtn">Staff Details</button>
            </div>
            ...
            <div className="secondHeading">
                ...
                <button id="naviBtn">Settings</button>
            </div>
            ...
            <div className="thirdHeading">
                ...
                <button id="naviBtn"><Link to={'/AddStaff'} style={{textDecoration:'none',color: "inherit"}}>Add Staff</Link>
                </button>
            </div>
            ...
            <div className="fourthHeading">
                ...
                <button id="naviBtn">View Staff</button>
            </div>
            </div> 
    </>
  )
